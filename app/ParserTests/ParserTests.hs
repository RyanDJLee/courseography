...
fromParInputs = [
    ...
    , ("0.5 from ANT204H1", FCES "0.5" $ J "ANT204H1" "")
    , ("0.5 from: RSM260H1, RSM270H1", FCES "0.5" $ AND [J "RSM260H1" "", J "RSM270H1" ""])
    -- META "in core ecology" $ FROM "0.5" $ J "EEB319H1" ""
    , ("0.5 in core ecology from: EEB319H1", FCES "0.5" $ J "EEB319H1" "")
    ]
